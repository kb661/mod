(function() {
  ...
  var Defined = {
    api: 'lampac',
    localhost: 'http://1it6m2d.rc.bwa.to/',
  ...
  if (Defined.rchtype === undefined) {
    ...
    if (Lampa.Platform.is('android') || Lampa.Platform.is('tizen')) check(true);
      ...
      net.silent('http://1it6m2d.rc.bwa.to'.indexOf(location.host) >= 0 ? 'https://github.com/' : 'http://1it6m2d.rc.bwa.to/cors/check', function() {
        check(true);
      }, function() {
        check(false);
      }, false, {
  ...
  function component(object) {
    ...
    this.rch = function(json, noreset) {
      ...
      if (typeof signalR == 'undefined') {
        Lampa.Utils.putScript(["http://1it6m2d.rc.bwa.to/signalr-6.0.25_es5.js"], function() {}, false, function() {
          load();
        }, true);
      } else load();
    };
